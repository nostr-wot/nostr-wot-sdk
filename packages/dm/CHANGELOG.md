...
- [#9](https://github.com/nostr-wot/nostr-wot-sdk/pull/9) [`d76b105`](https://github.com/nostr-wot/nostr-wot-sdk/commit/d76b105b5080c10b7b6d5edcd199f89beeebc455) Thanks [@leonacostaok](https://github.com/leonacostaok)! - Verify the rumor's `id` against its own content in `unwrapGiftWrap`, and require the rumor's `pubkey` rather than only checking it when present.
