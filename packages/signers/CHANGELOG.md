...
- [#7](https://github.com/nostr-wot/nostr-wot-sdk/pull/7) [`bdddcd6`](https://github.com/nostr-wot/nostr-wot-sdk/commit/bdddcd63e0181c8ee4d9906a31c93b02ca64ac9a) Thanks [@leonacostaok](https://github.com/leonacostaok)! - `NostrSigner.nip44Encrypt` gains an optional third argument, `opts: { scheme: 'pq'; recipientKemKey: string }`, for post-quantum sealing with `@nostr-wot/pq`'s hybrid ML-KEM-1024 + NIP-44 envelope. `nip44Decrypt` needs no new argument: a post-quantum payload is self-describing, so a supporting signer auto-routes to post-quantum decryption without the caller saying which kind of ciphertext it is.
...
- Updated dependencies [[`113c956`](https://github.com/nostr-wot/nostr-wot-sdk/commit/113c956a8f9ef2f6c84b72cc299163753951860c)]:
  - @nostr-wot/pq@0.2.2
...
- [#6](https://github.com/nostr-wot/nostr-wot-sdk/pull/6) [`7ecf9cb`](https://github.com/nostr-wot/nostr-wot-sdk/commit/7ecf9cbc4312f9b2d635ed2b5c1caf8fd3d237ab) Thanks [@leonacostaok](https://github.com/leonacostaok)! - Rebuild `Nip46Signer` as a thin adapter over `nostr-tools/nip46`'s `BunkerSigner`.
